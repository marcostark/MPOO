...
public class PainelGame extends JFrame {
	...
	public void inicia() {
		...
		while(jogando) {
			if(System.currentTimeMillis() >= prxAtualizacao){
				update(); // Atualizando o tratamento dos eventos de teclado, tudo � uma �nica thread
				tela.repaint();
	...
	// Metodo que cuida da atualiza��o do objeto na tela
		public void update() {
			...
			// Se o jogador sair por um lado da tela, aparecer� no outro
	...
	// Solu��o para melhorar a perfomace dos comandos, uma vez que est�o todos em uma �nica Thread
